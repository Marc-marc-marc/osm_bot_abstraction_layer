...
nwr[wheelchair=unknown](area.a);
out body;>;out skel qt;
""",
        cache_folder_filepath='/tmp',
        is_in_manual_mode=False,
        changeset_comment='suppression de wheelchair=unknown qui n apporte aucune information par rapport a l absence de l attribut wheelchair',
